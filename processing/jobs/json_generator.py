...
# # #     for i in range(6 * 24):  # hourly points
# # #         t = now - timedelta(hours=i)
...
# # #     # ---------------- FRESH DATA (LAST 1 HOUR) ----------------
# # #     for i in range(12):  # 5-min intervals
# # #         t = now - timedelta(minutes=i * 5)
...
# # #     print(f"✅ Generated {DEVICE_COUNT} files (history + fresh)")
...
# #         with open(f"{OUTPUT_DIR}/data_{device_id}_{timestamp}.json", "w") as f:
# #             json.dump(payload, f)

# #     time.sleep(300)  # KEEP REAL
# import json
# import time
# import os
# import random
...
#     print("⏱ REAL:", datetime.utcnow(), "| 🚀 SIM:", get_virtual_now())
